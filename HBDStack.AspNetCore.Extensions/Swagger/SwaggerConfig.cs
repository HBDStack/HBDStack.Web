...
public static class SwaggerConfig
{
    ...
    /// <returns></returns>
    public static SwaggerSecurityDefinitionHelper AddBearerSecurityDefinition(this SwaggerSecurityDefinitionHelper helper, string description = null)
    ...
    /// <returns></returns>
    public static SwaggerSecurityDefinitionHelper AddSecurityDefinition(this SwaggerSecurityDefinitionHelper helper, string scheme, string headerKey, string description = null, ParameterLocation location = ParameterLocation.Header,
    ...
    /// <returns></returns>
    public static IServiceCollection AddSwaggerConfig(this IServiceCollection services, SwaggerInfo info, Action<SwaggerSecurityDefinitionHelper> securityOptions = null, string xmlFile = null, Action<SwaggerGenOptions> genOption = null)
    {
        if (info != null)
    ...
    /// <returns></returns>
    public static IApplicationBuilder UseSwaggerAndUI(this IApplicationBuilder app, IApiVersionDescriptionProvider provider, string route = "docs", Action<SwaggerOptions> setupAction = null)
    {
        setupAction ??= c =>
        {
