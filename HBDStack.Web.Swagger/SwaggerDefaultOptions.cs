...
public class SwaggerDefaultOptions : IConfigureOptions<SwaggerGenOptions>
{
    ...
    public SwaggerDefaultOptions(IApiVersionDescriptionProvider provider, SwaggerInfo options,
        IEnumerable<IApiDocExtension> extensions)
    {
        _provider = provider;
        _options = options;
    ...
    private OpenApiInfo CreateInfoForApiVersion(ApiVersionDescription description)
    {
        var info = new OpenApiInfo()
        {
            ...
            Contact = string.IsNullOrEmpty(_options.Contact)
                ? null
                : new OpenApiContact() { Name = "Support", Email = _options.Contact },
            License = string.IsNullOrEmpty(_options.License)
                ? null
                : new OpenApiLicense() { Name = "License", Url = new Uri(_options.License) },
